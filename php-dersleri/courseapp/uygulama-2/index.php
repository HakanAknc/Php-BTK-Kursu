<?php
    ...
    $kurs3_resim = "3.jpg";
    $kurs3_yayinTarihi = "01.01.2024";
    $kurs3_yorumSayisi = "500";
    $kurs3_begeniSayisi = "300";

    $kurs1_altBaslik = ucfirst(strtolower($kurs1_altBaslik));    // ucfirst = cümlenin ilk harfini büyük yazar
    $kurs2_altBaslik = ucfirst(strtolower($kurs2_altBaslik));   // strtolower ise bütün harfleri küçük yazar
...
<body>
    ...
    <div class="container my-3">
        ...
        <div class="card mb-3">
            <div class="row">
                <div class="col-3">
                    <img src="img/<?php echo $kurs1_resim; ?>" alt="" class="img-fluid rounded-star">
                </div>
                <div class="col-9">
                    <div class="card-body">
                        <h5 class="card-title">
        ...
        <div class="card mb-3">
            <div class="row">
                <div class="col-3">
                    <img src="img/<?php echo $kurs2_resim; ?>" alt="" class="img-fluid rounded-star">
                </div>
                <div class="col-9">
                    <div class="card-body">
                        <h5 class="card-title">
        ...
        <div class="card mb-3">
            <div class="row">
                <div class="col-3">
                    <img src="img/<?php echo $kurs3_resim; ?>" alt="" class="img-fluid rounded-star">
                </div>
                <div class="col-9">
                    <div class="card-body">
                        <h5 class="card-title">
