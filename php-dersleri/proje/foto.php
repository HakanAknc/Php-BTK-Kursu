		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='9'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
				...
				<div class="card-body" border="0">
					<hr>
					<h4 align="center">Ayşenur & Safa </h4>
				</div>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='20'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='11'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='14'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='15'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='16'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
				...
				<div class="card-body">
					<hr>
					<h4 align="center">İrem & Berkan</h4>
				</div>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='17'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='18'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
				...
				<div class="card-body">
					<hr>
					<h4 align="center">Elif & Mustafa</h4>
				</div>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='13'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
		...
		<div class="col-md-4">
			<div class="card">
				<center>
					<div>
						<?php 
						$fotograf = $db->prepare("select * from tblfotograf where id='19'");
						$fotograf->execute(array());
						$foto2=$fotograf->fetchALL(PDO::FETCH_ASSOC);
